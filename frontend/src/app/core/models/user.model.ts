...
export class User extends Model {
  // These are the values that will be sent to the API
  apiUpdateValues:Array<string> = ['email', 'phone', 'first', 'last','role'];
...
//Grabs currently authenticated user
  static Auth(){
    ...
    if(user){
      ...
      //get the users token expiration time if it is up log them out
